...
<section class="section-padding gray-bg">
  <div class="container">
    <div class="section-header text-center">
      ...
      <p>Looking to rent a car that matches your needs and budget? At CarForYou, we offer a range of quality vehicles for every purpose—from efficient sedans to spacious SUVs. Each car is thoroughly inspected, well-maintained, and ready for your next adventure, ensuring a comfortable and reliable rental experience every time..</p>
    </div>
    <div class="row"> 
...
<span class="price"><?php echo htmlentities($result->PricePerDay);?> Taka /Day</span> 
</div>
